...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PINKVENOM-MD;HJdWBR7L#iN0IGv6d4VUw3avqsINWJ3SGHgCoDb6Z5TeTTtUSXqY' : process.env.SESSION_ID, //ADD YOUR SESSION ID
